//This example comes from coderbyte
//It is called Letter Changes


//This challenge requires you to change every letter in the string to the letter
//following it in the alphabet, so a becomes b, z becomes a, etc.
...
console.log(LetterChanges("fun times!")); //returns -> gvO Ujnft!
console.log(LetterChanges("123 ABC def gHi JkL !@# $%^")); //returns -> 123 BCD Efg hIj KlM !@# $%^
console.log(LetterChanges("alligator")); //returns -> bmmjhbUps
